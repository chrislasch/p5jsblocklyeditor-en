...
Blockly.Blocks["ellipse_var"] = {
  init: function () {
    ...
    this.appendValueInput("breite").setCheck("Number").appendField("| width ="); // was "| Breite ="
    this.appendValueInput("hoehe").setCheck("Number").appendField("height ="); // was "Höhe ="
...
Blockly.JavaScript["ellipse_var"] = function (block) {
  ...
  var value_hoehe = Blockly.JavaScript.valueToCode(
    block,
    "hoehe",
    Blockly.JavaScript.ORDER_ATOMIC
  );
...
Blockly.Blocks["point_var"] = {
  init: function () {
    this.appendDummyInput().appendField("Point"); // was "Punkt"
    this.appendValueInput("x").setCheck("Number").appendField("x =");
    this.appendValueInput("y").setCheck("Number").appendField("y =");
    this.setInputsInline(true);
    this.setPreviousStatement(true, null);
...
Blockly.Blocks["line_var"] = {
  init: function () {
    this.appendDummyInput().appendField("Line"); // was "Linie"
...
Blockly.Blocks["triangle_var"] = {
  init: function () {
    this.appendDummyInput().appendField("Triangle"); // was "Dreieck"
    this.appendValueInput("x1").setCheck("Number").appendField("x1 =");
    this.appendValueInput("y1").setCheck("Number").appendField("y1 =");
    this.appendValueInput("x2").setCheck("Number").appendField("| x2 =");
    this.appendValueInput("y2").setCheck("Number").appendField("y2 =");
...
Blockly.Blocks["rect_var"] = {
  init: function () {
    this.appendDummyInput().appendField("Rectangle"); // was "Rechteck"
    this.appendValueInput("x").setCheck("Number").appendField("x =");
    this.appendValueInput("y").setCheck("Number").appendField("y =");
    this.appendValueInput("breite").setCheck("Number").appendField("| width ="); // was "| Breite ="
    this.appendValueInput("hoehe").setCheck("Number").appendField("height ="); // was "Höhe ="
...
Blockly.Blocks["polygon"] = {
  init: function () {
    this.appendDummyInput().appendField("Draw polygon:"); // was "Vieleck zeichnen:"
    this.appendStatementInput("vertices").setCheck(null);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(farbeVarGrundformen);
...
Blockly.Blocks["vertex_var"] = {
  init: function () {
    this.appendDummyInput().appendField("Polygon: vertex"); // was "Vieleck: Eckpunkt"
    this.appendValueInput("x").setCheck("Number").appendField("x =");
    this.appendValueInput("y").setCheck("Number").appendField("y =");
    this.setInputsInline(true);
    this.setPreviousStatement(true, null);
...
Blockly.Blocks["winkel_num"] = {
  init: function () {
    this.appendDummyInput().appendField(new Blockly.FieldAngle(90), "winkel");
    this.setOutput(true, null);
    this.setColour(230);
    this.setTooltip("");
    this.setHelpUrl("");
...
Blockly.Blocks["p5_image_load"] = {
  init: function () {
    this.appendValueInput("imgVar").appendField("Image variable:"); // was "Bildvariable:"
    this.appendDummyInput().appendField(" | Image in Base64 format:"); // was " | Bild im Base64-Format:"
    this.appendValueInput("imgString").setCheck("String");
    this.setInputsInline(true);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(farbeVarGrundformen);
    this.setTooltip(
      "The image must be encoded in Base64 format. There are online converter tools."
    ); // was "Das Bild muss im Base64-Format codiert werden. Konvertier-Tools gibt es Online."
    this.setHelpUrl("");
  },
};

Blockly.JavaScript["p5_image_load"] = function (block) {
  var value_imgVar = Blockly.JavaScript.valueToCode(
    block,
    "imgVar",
    Blockly.JavaScript.ORDER_ATOMIC
  );
  var value_imgString = Blockly.JavaScript.valueToCode(
    block,
    "imgString",
    Blockly.JavaScript.ORDER_ATOMIC
  );
  var code =
    "  " + value_imgVar + " = p5sketch.loadImage(" + value_imgString + ");\n";
  return code;
};
...
Blockly.Blocks["arc_var"] = {
  init: function () {
    this.appendDummyInput().appendField("Arc");
    this.appendValueInput("x").setCheck("Number").appendField("x =");
    this.appendValueInput("y").setCheck("Number").appendField("y =");
    this.appendValueInput("breite").setCheck("Number").appendField("| width =");
    this.appendValueInput("hoehe").setCheck("Number").appendField("height =");
    this.appendValueInput("start")
      .setCheck("Number")
      .appendField("| start angle =");
    this.appendValueInput("stop")
      .setCheck("Number")
      .appendField("stop angle =");
    this.setInputsInline(true);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(farbeVarGrundformen);
    this.setTooltip(
      "Draws an arc at (x, y) with width, height, from start to stop angle (in radians)"
    );
    this.setHelpUrl("https://p5js.org/reference/#/p5/arc");
  },
};

Blockly.JavaScript["arc_var"] = function (block) {
  var value_x = Blockly.JavaScript.valueToCode(
    block,
    "x",
    Blockly.JavaScript.ORDER_ATOMIC
  ...
  var value_stop = Blockly.JavaScript.valueToCode(
    block,
    "stop",
    Blockly.JavaScript.ORDER_ATOMIC
  );
